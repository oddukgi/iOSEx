...
//  Cashmallow
//
//  Created by Sunmi on 2021/03/11.
//
...
extension KeyedDecodingContainer {
    ...
    func decodeIfPresent(_ type: Decimal.Type, forKey key: K, transformFrom: String.Type) throws -> Decimal? {
    ...
    func decodeIfPresent(_ type: Decimal.Type, forKey key: K, transformFrom: Double.Type) throws -> Decimal? {
    ...
    func decode(_ type: Decimal.Type, forKey key: K, transformFrom: String.Type) throws -> Decimal {

        guard let valueAsString = try? decode(transformFrom, forKey: key),
              let value = Decimal(string: valueAsString) else {
